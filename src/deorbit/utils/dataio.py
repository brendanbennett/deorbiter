...
def save_sim_data(data: SimData, config: SimConfig, dir_path_string: str, format: str, run_time: datetime) -> Path:
...
def _get_filename(
    stem: str, dir_path: None | str = None, file_type: None | str = None, run_time: datetime | None = None
) -> str:
...
def load_sim_data(dir_path: str) -> SimData:
    ...
    for p in dir_path.iterdir():
        if p.stem.startswith(DATA_STEM):
            path = p
            break
