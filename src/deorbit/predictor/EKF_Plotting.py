...
class EKF_Plotting:
    """
    This class, EKF_Plotting, encapsulates various plotting methods for visualizing trajectories, errors, and other relevant data associated with the Extended Kalman Filter (EKF) applied to satellite motion.
...
#########################################################  If you want just 2D  #########################################################
    @staticmethod
    def Two_Dim_plot_trajectories(true_traj, estimated_traj, observations, title="Trajectories"):
        fig, ax = plt.subplots()
        ...
        plt.close()
    @staticmethod
    def Two_Dim_plot_error(true_traj, estimated_traj, title="Error in Trajectories"):
...
#########################################################  If you want just 3D  #########################################################
    @staticmethod
    def Three_Dim_plot_trajectories(true_traj, estimated_traj, observations, title="3D Trajectories"):
        fig = plt.figure()
